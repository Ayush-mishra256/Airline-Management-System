...
public class BookFlight extends JFrame implements ActionListener {
    ...
    add(tfaadhar);
     ...
     fetchButton= new JButton("Fetch Users");
    ...
    lblfcode.setFont(new Font("Arial",Font.BOLD,20));
    add(lblfcode);
    ...
    add(lbladdress);
      ...
      Image i2=i1.getImage().getScaledInstance(280, 400, Image.SCALE_SMOOTH);
      ImageIcon image= new ImageIcon(i2);
      JLabel lblimage= new JLabel(image);
      lblimage.setBounds(560,80,280,400);
       add(lblimage);
